            ...
            <div>
              ...
              <ul className="space-y-4" role="list">
                <li className="flex items-start gap-3">
                  ...
                  <a href="tel:{{ phone_number }}" className="text-white/50 text-sm hover:text-(--brand-amber) transition-colors duration-200 font-sans">
                    {"{{ phone_number }}"}
                  </a>
                </li>
                <li className="flex items-start gap-3">
                  <Mail size={15} className="text-(--brand-amber) shrink-0 mt-0.5" aria-hidden="true" />
                  <a href="mailto:{{ email_address }}" className="text-white/50 text-sm hover:text-(--brand-amber) transition-colors duration-200 font-sans">
                    {"{{ email_address }}"}
                  </a>
                </li>
                <li className="flex items-start gap-3">
                  <MapPin size={15} className="text-(--brand-amber) shrink-0 mt-0.5" aria-hidden="true" />
                  <span className="text-white/50 text-sm font-sans">{"{{ service_area }}"}</span>
                </li>
              </ul>
              ...
              <a
                ...
                className="mt-6 inline-block px-5 py-2.5 bg-(--brand-amber) text-(--brand-navy) text-xs font-bold uppercase tracking-wider rounded-lg hover:bg-(--brand-amber-light) hover:shadow-md hover:shadow-(--brand-amber)/30 transition-all duration-300"
              >
                {"{{ footer_cta_button }}"}
              </a>
            </div>
